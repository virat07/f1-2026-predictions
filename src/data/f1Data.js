...
// Race Calendar Data
export const races = [
  { round: 1, flag: '🇦🇺', name: 'Australian Grand Prix', circuit: 'Melbourne', date: 'Mar 6–8', prediction: '🏆 Hamilton wins on Ferrari debut', previousWinners: ['Leclerc (2025)', 'Verstappen (2024)', 'Verstappen (2023)'] },
  { round: 2, flag: '🇨🇳', name: 'Chinese Grand Prix', circuit: 'Shanghai', date: 'Mar 13–15', prediction: '🏆 Norris dominates from pole', isSprint: true, previousWinners: ['Verstappen (2024)', 'Hamilton (2019)', 'Ricciardo (2018)'] },
  { round: 3, flag: '🇯🇵', name: 'Japanese Grand Prix', circuit: 'Suzuka', date: 'Mar 27–29', prediction: '🏆 Verstappen shows Red Bull\'s pace', previousWinners: ['Verstappen (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 4, flag: '🇧🇭', name: 'Bahrain Grand Prix', circuit: 'Sakhir', date: 'Apr 10–12', prediction: '🏆 Leclerc Ferrari 1-2', previousWinners: ['Verstappen (2024)', 'Verstappen (2023)', 'Leclerc (2022)'] },
  { round: 5, flag: '🇸🇦', name: 'Saudi Arabian Grand Prix', circuit: 'Jeddah', date: 'Apr 17–19', prediction: '🏆 Hamilton under the lights', previousWinners: ['Verstappen (2024)', 'Perez (2023)', 'Verstappen (2022)'] },
  { round: 6, flag: '🇺🇸', name: 'Miami Grand Prix', circuit: 'Miami', date: 'May 1–3', prediction: '🏆 Norris takes the fight to Ferrari', isSprint: true, previousWinners: ['Norris (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 7, flag: '🇨🇦', name: 'Canadian Grand Prix', circuit: 'Montreal', date: 'May 22–24', prediction: '🏆 Verstappen masters the rain', isSprint: true, previousWinners: ['Verstappen (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 8, flag: '🇲🇨', name: 'Monaco Grand Prix', circuit: 'Monaco', date: 'June 5–7', prediction: '🏆 Leclerc wins at home again', previousWinners: ['Leclerc (2024)', 'Verstappen (2023)', 'Perez (2022)'] },
  { round: 9, flag: '🇪🇸', name: 'Spanish Grand Prix', circuit: 'Barcelona', date: 'June 12–14', prediction: '🏆 Russell\'s Mercedes breakthrough', previousWinners: ['Verstappen (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 10, flag: '🇦🇹', name: 'Austrian Grand Prix', circuit: 'Spielberg', date: 'June 26–28', prediction: '🏆 Verstappen dominates at home', previousWinners: ['Russell (2024)', 'Verstappen (2023)', 'Leclerc (2022)'] },
  { round: 11, flag: '🇬🇧', name: 'British Grand Prix', circuit: 'Silverstone', date: 'July 3–5', prediction: '🏆 Hamilton wins for the crowds', isSprint: true, previousWinners: ['Hamilton (2024)', 'Verstappen (2023)', 'Sainz (2022)'] },
  { round: 12, flag: '🇧🇪', name: 'Belgian Grand Prix', circuit: 'Spa', date: 'July 17–19', prediction: '🏆 Piastri\'s breakout drive', previousWinners: ['Hamilton (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 13, flag: '🇭🇺', name: 'Hungarian Grand Prix', circuit: 'Budapest', date: 'July 24–26', prediction: '🏆 Norris dominates tight track', previousWinners: ['Piastri (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 14, flag: '🇳🇱', name: 'Dutch Grand Prix', circuit: 'Zandvoort', date: 'Aug 21–23', prediction: '🏆 Verstappen\'s final Zandvoort farewell', isSprint: true, previousWinners: ['Norris (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 15, flag: '🇮🇹', name: 'Italian Grand Prix', circuit: 'Monza', date: 'Sept 4–6', prediction: '🏆 Ferrari Tifosi dream — Hamilton wins', previousWinners: ['Leclerc (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 16, flag: '🇪🇸', name: 'Madrid Grand Prix', circuit: 'Madrid', date: 'Sept 11–13', prediction: '🏆 Leclerc shines at the new venue', previousWinners: ['N/A (New Circuit)'] },
  { round: 17, flag: '🇦🇿', name: 'Azerbaijan Grand Prix', circuit: 'Baku', date: 'Sept 24–26', prediction: '🏆 Chaos race — Antonelli podium!', previousWinners: ['Piastri (2024)', 'Perez (2023)', 'Verstappen (2022)'] },
  { round: 18, flag: '🇸🇬', name: 'Singapore Grand Prix', circuit: 'Singapore', date: 'Oct 9–11', prediction: '🏆 Leclerc under the lights', isSprint: true, previousWinners: ['Norris (2024)', 'Sainz (2023)', 'Perez (2022)'] },
  { round: 19, flag: '🇺🇸', name: 'United States Grand Prix', circuit: 'Austin', date: 'Oct 23–25', prediction: '🏆 Hamilton seals the title deal', previousWinners: ['Leclerc (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 20, flag: '🇲🇽', name: 'Mexican Grand Prix', circuit: 'Mexico City', date: 'Oct 30 – Nov 1', prediction: '🏆 Verstappen altitude advantage', previousWinners: ['Sainz (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
  { round: 21, flag: '🇧🇷', name: 'Brazilian Grand Prix', circuit: 'São Paulo', date: 'Nov 6–8', prediction: '🏆 Classic Interlagos rain drama', previousWinners: ['Verstappen (2024)', 'Verstappen (2023)', 'Russell (2022)'] },
  { round: 22, flag: '🇺🇸', name: 'Las Vegas Grand Prix', circuit: 'Las Vegas', date: 'Nov 19–21', prediction: '🏆 Norris shines under neon', previousWinners: ['Russell (2024)', 'Verstappen (2023)'] },
  { round: 23, flag: '🇶🇦', name: 'Qatar Grand Prix', circuit: 'Lusail', date: 'Nov 27–29', prediction: '🏆 Hamilton extends the lead', previousWinners: ['Verstappen (2024)', 'Verstappen (2023)', 'Hamilton (2021)'] },
  { round: 24, flag: '🇦🇪', name: 'Abu Dhabi Grand Prix', circuit: 'Yas Marina', date: 'Dec 4–6', prediction: '🏆 CHAMPION CROWNED — Hamilton 8x WDC', previousWinners: ['Hamilton (2024)', 'Verstappen (2023)', 'Verstappen (2022)'] },
]
